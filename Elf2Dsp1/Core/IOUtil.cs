...
namespace Elf2Dsp1.Core
{
	public class IOUtil
	{
	    ...
	    public static int ReadSignedLeb128(EndianBinaryReader er)
	    {
	        byte val;
	        int result = 0;
	        int shift = 0;
	    ...
	    public static uint ReadUnsignedLeb128(EndianBinaryReader er)
	    {
	        byte val;
	        uint result = 0;
	        int shift = 0;
